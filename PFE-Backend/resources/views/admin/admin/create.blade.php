...
@section('subtitle', 'Le mot de passe est généré automatiquement et envoyé par email au nouvel administrateur.')

@section('content')

    <div class="admin-card">
        <form method="POST" action="{{ route('admin.admin.store') }}" class="admin-form">
            @csrf
            ...
            <div class="admin-form-actions">
                <button type="submit" class="admin-btn admin-btn-blue">Créer l'administrateur</button>
